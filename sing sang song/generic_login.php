			...
			<section id="One" class="wrapper style3">
				<div class="inner">
					<header class="align-center">
						<p>Do ur best</p>
						<h2 style="font-family:Microsoft JhengHei;">履歷資料</h2>
					</header>
				</div>
			</section>
			...
			<section id="two" class="wrapper style2">
				...
				<script type="text/javascript">	
					...
					Modernizr.load({
						...
						yep : ['http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js','assets/js_crease/jquery.hoverfold.js'],
						nope: 'assets/css_crease/fallback.css',
						callback : function( url, result, key ) {
								
							if( url === 'assets/js_crease/jquery.hoverfold.js' ) {
						$( '#grid' ).hoverfold();
							}
